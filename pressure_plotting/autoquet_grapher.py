...
quantities_to_graph = [
    ...
    # [["Test measurement1", "green"]],
    # [["Test measurement2", "red"]],
    # [["Test measurement3", "orange"]],
    # [["Test measurement4", "purple"]],
    # [["Test measurement5", "green"], ["Completely fake measurement", "pink"]],
    # [["Test measurement5", "green"], ["Completely fake measurement", "pink"]],
]
...
graph_limits = [
    ...
    # Plot 1: Cuff pressure with set point pressure
    {"window":100, "y_lower":-0.1, "y_upper":150, "graph title":"Cuff pressure vs time",    "graph y_label": "Cuff pressure (mmHg)", "plot start": 0, "advance by": 20},
    ...
    {"window": 60, "y_lower": 0, "y_upper": 5000, "graph title": "Measured blood flow summation", "graph y_label": "Qauntized pulse strength (unitless)", "plot start": 0, "advance by": 20},

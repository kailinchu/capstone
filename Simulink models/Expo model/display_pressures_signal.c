/*
 * File: display_pressures_signal.c
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 10:22:25 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                display_pressures_signal
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 pressure_set_point
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 operation_state
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                display_pressure_signal
...
extern void display_pressures_signal_Start_wrapper(void);
extern void display_pressures_signal_Outputs_wrapper(const real32_T
  *pressure_set_point,
...
{
  const real32_T *pressure_set_point = (real32_T *) ssGetInputPortRealSignal(S,
    0);
  const uint8_T *operation_state = (uint8_T *) ssGetInputPortRealSignal(S, 1);
  const uint32_T *time = (uint32_T *) ssGetInputPortRealSignal(S, 2);
  uint8_T *display_pressure_signal = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  display_pressures_signal_Outputs_wrapper(pressure_set_point, operation_state,
    time, display_pressure_signal);
}

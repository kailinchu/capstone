 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Mar 16 19:14:44 2026
 */
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 operating_mode
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                ideal_pressure_found
...
extern void test1_Outputs_wrapper(const uint8_T *operating_mode,
...
{
  const uint8_T *operating_mode = (uint8_T *) ssGetInputPortRealSignal(S, 0);
  real_T *ideal_pressure_found = (real_T *) ssGetOutputPortRealSignal(S, 0);
  test1_Outputs_wrapper(operating_mode, ideal_pressure_found);
}

 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 12:56:39 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                blood_flow_detector_2
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 disruption_active
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 bloodflow_threshold
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 inflation_state
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                bloodflow_boolean
...
extern void blood_flow_detector_2_Start_wrapper(void);
extern void blood_flow_detector_2_Outputs_wrapper(const real32_T *u0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const boolean_T *disruption_active = (boolean_T *) ssGetInputPortRealSignal(S,
    1);
  const uint16_T *bloodflow_threshold = (uint16_T *) ssGetInputPortRealSignal(S,
    2);
  const uint8_T *inflation_state = (uint8_T *) ssGetInputPortRealSignal(S, 3);
  uint16_T *y0 = (uint16_T *) ssGetOutputPortRealSignal(S, 0);
  boolean_T *bloodflow_boolean = (boolean_T *) ssGetOutputPortRealSignal(S, 1);
  blood_flow_detector_2_Outputs_wrapper(u0, disruption_active,
    bloodflow_threshold, inflation_state, y0, bloodflow_boolean);
}

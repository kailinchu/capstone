/*
 * File: disruption_activity_monitor.c
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 09:59:17 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                disruption_activity_monitor
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 motor_active
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 movement_detected
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 pause_time
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                pause_summation
...
extern void disruption_activity_monitor_Outputs_wrapper(const boolean_T
  *motor_active,
...
{
  const boolean_T *motor_active = (boolean_T *) ssGetInputPortRealSignal(S, 0);
  const boolean_T *movement_detected = (boolean_T *) ssGetInputPortRealSignal(S,
    1);
  const uint32_T *time = (uint32_T *) ssGetInputPortRealSignal(S, 2);
  const uint16_T *pause_time = (uint16_T *) ssGetInputPortRealSignal(S, 3);
  boolean_T *pause_summation = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
  disruption_activity_monitor_Outputs_wrapper(motor_active, movement_detected,
    time, pause_time, pause_summation);
}

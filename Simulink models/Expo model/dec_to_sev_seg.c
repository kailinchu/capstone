 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 21:05:17 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                dec_to_sev_seg
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 time_input
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                binary_time
...
extern void dec_to_sev_seg_Outputs_wrapper(const uint8_T *time_input,
  uint8_T *binary_time);
...
{
  const uint8_T *time_input = (uint8_T *) ssGetInputPortRealSignal(S, 0);
  uint8_T *binary_time = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  dec_to_sev_seg_Outputs_wrapper(time_input, binary_time);
}

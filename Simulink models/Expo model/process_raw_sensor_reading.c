/*
 * File: process_raw_sensor_reading.c
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 08:27:04 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                process_raw_sensor_reading
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 raw_sensor_input
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                limb_pressure_mmhg
...
extern void process_raw_sensor_reading_Outputs_wrapper(const uint8_T
  *raw_sensor_input,
...
{
  const uint8_T *raw_sensor_input = (uint8_T *) ssGetInputPortRealSignal(S, 0);
  real32_T *limb_pressure_mmhg = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  process_raw_sensor_reading_Outputs_wrapper(raw_sensor_input,
    limb_pressure_mmhg);
}

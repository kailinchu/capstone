 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 18:52:19 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                time_keeper
...
extern void time_keeper_Start_wrapper(void);
extern void time_keeper_Outputs_wrapper(uint8_T *my_time,
  uint32_T *ticks);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  time_keeper_Outputs_wrapper(my_time, ticks);
}

 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 15:36:30 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                pressure_display
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 set_point_pressure
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                digit_array
...
extern void pressure_display_Outputs_wrapper(const real32_T *set_point_pressure,
  uint8_T *digit_array);
...
{
  const real32_T *set_point_pressure = (real32_T *) ssGetInputPortRealSignal(S,
    0);
  uint8_T *digit_array = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  pressure_display_Outputs_wrapper(set_point_pressure, digit_array);
}

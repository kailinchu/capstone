 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 07:34:45 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                button_control_logic
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 button_signals
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 auto_pressure_setpoint
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 initial_search
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                pressure_set_point
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                roughness
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                operation_mode
...
extern void button_control_logic_Start_wrapper(void);
extern void button_control_logic_Outputs_wrapper(const boolean_T *button_signals,
  const uint32_T *time,
...
{
  const boolean_T *button_signals = (boolean_T *) ssGetInputPortRealSignal(S, 0);
  const uint32_T *time = (uint32_T *) ssGetInputPortRealSignal(S, 1);
  const real32_T *auto_pressure_setpoint = (real32_T *) ssGetInputPortRealSignal
    (S, 2);
  const uint8_T *initial_search = (uint8_T *) ssGetInputPortRealSignal(S, 3);
  real32_T *pressure_set_point = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  uint8_T *roughness = (uint8_T *) ssGetOutputPortRealSignal(S, 1);
  uint8_T *operation_mode = (uint8_T *) ssGetOutputPortRealSignal(S, 2);
  button_control_logic_Outputs_wrapper(button_signals, time,
    auto_pressure_setpoint, initial_search, pressure_set_point, roughness,
    operation_mode);
}

 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 09:58:26 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                limb_movement_detector
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 limb_acceleration
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 accel_threshold
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                movement_boolean
...
extern void limb_movement_detector_Start_wrapper(void);
extern void limb_movement_detector_Outputs_wrapper(const real32_T
  *limb_acceleration,
...
{
  const real32_T *limb_acceleration = (real32_T *) ssGetInputPortRealSignal(S, 0);
  const uint16_T *accel_threshold = (uint16_T *) ssGetInputPortRealSignal(S, 1);
  boolean_T *movement_boolean = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
  limb_movement_detector_Outputs_wrapper(limb_acceleration, accel_threshold,
    movement_boolean);
}

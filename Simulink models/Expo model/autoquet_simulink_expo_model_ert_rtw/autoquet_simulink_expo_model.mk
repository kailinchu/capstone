###########################################################################
## Makefile generated for component 'autoquet_simulink_expo_model'. 
## 
## Makefile     : autoquet_simulink_expo_model.mk
## Generated on : Tue Mar 17 14:39:57 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/autoquet_simulink_expo_model.elf
...
PRODUCT_NAME              = autoquet_simulink_expo_model
MAKEFILE                  = autoquet_simulink_expo_model.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/autoquet_simulink_expo_model.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/autoquet_simulink_expo_model_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(START_DIR)/slprj/ert/_sharedutils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/leonardo -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/aIDE/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/aIDE/hardware/arduino/avr/LIBRAR~1/Wire/src/utility -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/aIDE/hardware/arduino/avr/LIBRAR~1/SPI/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/aIDE/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/aIDE/LIBRAR~1/Servo/src/avr
...
DEFINES_STANDARD = -DMODEL=autoquet_simulink_expo_model -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_arduinoI2C.o io_wrappers.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_SerialRead.o MW_SerialWrite.o autoquet_simulink_expo_model.o autoquet_simulink_expo_model_data.o send_params.o blood_flow_detector_2_wrapper.o button_control_logic_wrapper.o custom_demux_wrapper.o dec_to_sev_seg_wrapper.o display_pressures_signal_wrapper.o disruption_activity_monitor_wrapper.o limb_movement_detector_wrapper.o motor_drive_control_wrapper.o pressure_display_wrapper.o process_raw_sensor_reading_wrapper.o time_keeper_wrapper.o MW_ArduinoHWInit.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
autoquet_simulink_expo_model.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/autoquet_simulink_expo_model.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


autoquet_simulink_expo_model_data.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/autoquet_simulink_expo_model_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


send_params.o : $(START_DIR)/autoquet_simulink_expo_model_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
...
time_keeper_wrapper.o : $(START_DIR)/time_keeper_wrapper.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")

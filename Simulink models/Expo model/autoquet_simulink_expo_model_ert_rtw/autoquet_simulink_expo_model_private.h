 ...
 *
 * File: autoquet_simulink_expo_model_private.h
 *
...
#ifndef RTW_HEADER_autoquet_simulink_expo_model_private_h_
#define RTW_HEADER_autoquet_simulink_expo_model_private_h_
#include "rtwtypes.h"
...
SFB_EXTERN_C void display_pressures_signal_Outputs_wrapper(const real32_T
  *pressure_set_point,
...
SFB_EXTERN_C void time_keeper_Start_wrapper(void);
SFB_EXTERN_C void time_keeper_Outputs_wrapper(uint8_T *my_time,
  uint32_T *ticks);
SFB_EXTERN_C void time_keeper_Terminate_wrapper(void);

#undef SFB_EXTERN_C
#endif                  /* RTW_HEADER_autoquet_simulink_expo_model_private_h_ */

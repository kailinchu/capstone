 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 08:28:10 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                custom_demux
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 combined_vector
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                filtered_pressure
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                filtered_acceleration
...
extern void custom_demux_Outputs_wrapper(const real32_T *combined_vector,
...
{
  const real32_T *combined_vector = (real32_T *) ssGetInputPortRealSignal(S, 0);
  real32_T *filtered_pressure = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *filtered_acceleration = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  custom_demux_Outputs_wrapper(combined_vector, filtered_pressure,

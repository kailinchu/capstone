 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Mar 16 11:09:33 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                test_serial
...
extern void test_serial_Outputs_wrapper(const real_T *u0,
  real_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  test_serial_Outputs_wrapper(u0, y0);
}

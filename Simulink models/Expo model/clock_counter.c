 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 17 14:36:07 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                clock_counter
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                my_time
...
extern void clock_counter_Start_wrapper(void);
extern void clock_counter_Outputs_wrapper(const real_T *u0,
  uint8_T *my_time,
  uint32_T *ticks);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint8_T *my_time = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  uint32_T *ticks = (uint32_T *) ssGetOutputPortRealSignal(S, 1);
  clock_counter_Outputs_wrapper(u0, my_time, ticks);
}
